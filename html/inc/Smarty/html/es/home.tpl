	...
	if (AC_FL_RunContent == 0) {
		...
		AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0','name','cabezal','width','885','height','272','align','middle','id','cabezal','flashvars','seccion={/literal}{$seccion}{literal}&idioma=2','src','intro','quality','high','bgcolor','#ffffff','allowscriptaccess','sameDomain','allowfullscreen','false','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','intro' ); //end AC code
                                              ...
                                              <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" name="cabezal" width="885" height="272" align="middle" id="cabezal">
                                                ...
                                                <param name="FlashVars" value="seccion={/literal}{$seccion}{literal}&idioma=2" />
                                                <embed FlashVars="seccion={/literal}{$seccion}{literal}" src="intro.swf" quality="high" bgcolor="#ffffff" width="885" height="272" name="cabezal" align="middle" allowscriptaccess="sameDomain" allowfullscreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" FlashVars="idioma=2" />                                              
</object>
                                              </noscript>
                                            {/literal}
                                            {else}
	...
	if (AC_FL_RunContent == 0) {
		...
		AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0','width','885','height','272','id','cabezal','align','middle','src','cabezal','quality','high','bgcolor','#ffffff','name','cabezal','allowscriptaccess','sameDomain','allowfullscreen','false','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','cabezal', 'FlashVars', 'seccion={/literal}{$seccionFlash[$seccion]}{literal}&idioma=2' ); //end AC code
                                              ...
                                              <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="885" height="272" id="cabezal" align="middle">
                                                ...
                                                <param name="quality" value="high" />
                                                <param name="bgcolor" value="#ffffff" />
                                                <param name="FlashVars" value="seccion={/literal}{$seccionFlash[$seccion]}{literal}" />
                                                <embed FlashVars="seccion={/literal}{$SECCIONFLASH[$seccion]}{literal}" src="cabezal.swf" quality="high" bgcolor="#ffffff" width="885" height="272" name="cabezal" align="middle" allowscriptaccess="sameDomain" allowfullscreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />                                              
</object>
                                              </noscript>
                                            {/literal}    
                                                        	...
                                                        	<td>
                                                                ...
                                                                <tr>
                                                                    <td class="pastillaInterior">
                                                                        ...
                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td class="{if $menu=="1"}opcionhover{else}opcion{/if}" id="" height="32"><a href="coneixeunos_topguay.php?idioma=es">TopGuay</a></td>
                                                                        </tr>
<tr><td class="{if $menu=="2"}opcionhover{else}opcion{/if}" id="" height="32"><a href="coneixeunos_projecte_social.php?idioma=es">Proyecto Social</a></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="{if $menu=="3"}opcionhover{else}opcion{/if}" id="" height="32"><a href="coneixeunos_contacteunos.php?idioma=es">Contactar</a></td>
                                                                        </tr>
<!--                                                                        
                                                                        <tr>
<td class="{if $menu=="4"}opcionhover{else}opcion{/if}" id="" height="32"><a href="http://www.myspace.com/topguay">Blog / Noticias</a></td>
                                                                        </tr>
-->                                                                        
                                                           ...
                                                           <table width="100%" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td class="pastillaInterior">
                                                                        ...
                                                                        <tr id="ei" {if $submenu!="1"}class="opcion1" style="display:none;" {/if}>
                                                                        	<td>
                                                                                    ...
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="1" && $subsubmenu=="1"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_la_peca.php?idioma=es">La Peca</a></td>
                                                                                    </tr>
                                                                                  <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="1" && $subsubmenu=="2"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_catarsis.php?idioma=es">Catarsis</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="1" && $subsubmenu=="3"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_marrameu.php?idioma=es">Marrameu</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="1" && $subsubmenu=="4"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_avi_tio.php?idioma=es">El abuelo Tió, Caga mejor!</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="1" && $subsubmenu=="5"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_agenda_stjordi.php?idioma=es">La Agenda de Sant Jordi la aut&eacute;ntica...</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="1" && $subsubmenu=="6"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_gags_clown.php?idioma=es">Gags de Clown adultos</a></td>
                                                                                    </tr>
                                                                                    </table>
                                                                        ...
                                                                        <tr id="ei" {if $submenu!="2"}class="opcion2" style="display:none;" {/if}>
                                                                        	<td>
                                                                                    ...
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="2" && $subsubmenu=="1"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_cercaviles.php?idioma=es">Pasacalles</a></td>
                                                                                    </tr>
                                                                                  <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="2" && $subsubmenu=="2"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_personatges_populars.php?idioma=es">Personajes Populares</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="2" && $subsubmenu=="3"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_accions.php?idioma=es">Acciones a la carta</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="2" && $subsubmenu=="4"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_speek_comic.php?idioma=es">Speek comic</a></td>
                                                                                    </tr>
                                                                                    </table>
...
<tr id="ei" {if $submenu!="3"}class="opcion3" style="display:none;" {/if}>
                                                                        	<td>
                                                                                    ...
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="1"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_diver_tallers.php?idioma=es">Diver Talleres</a></td>
                                                                                    </tr>
                                                                                  <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="2"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_taller_circ.php?idioma=es">Taller de Circo</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="3"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_taller_nadalenc.php?idioma=es">Taller Navide&ntilde;o</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="4"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_taller_carnestoltes.php?idioma=es">Taller de Carnaval</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="5"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_taller_medievals.php?idioma=es">Talleres Medievales</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="6"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_festes_tematiques.php?idioma=es">Fiestas Tem&aacute;ticas</a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td height="1" class="separador"><img src="images/spacer.gif" width="1" height="1"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="3" && $subsubmenu=="7"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_puzzlequeria.php?idioma=es">Puzzlequeria Rompecabezas</a></td>
                                                                                    </tr>
                                                                                    </table>
...
<tr id="ei" {if $submenu!="4"}class="opcion4" style="display:none;" {/if}>
                                                                        	<td>
                                                                                    ...
                                                                                    <tr>
                                                                                    	<td class="{if $submenu=="4" && $subsubmenu=="1"}subopcionhover{else}subopcion{/if}" height="32"><a href="serveis_namaskar.php?idioma=es">Namaskar</a></td>
                                                                                    </tr>
                                                                                    </table>
                                                                             </td>
                                                                        </tr>
                                                                      ...
                                                                      <!--  <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="{if $submenu=="5"}opcionhover{else}opcion{/if}" id="opcion5" height="32"><a id="opcion5" href="enllacos.php?idioma=es">Enlaces relacionados</a></td>
                                                                        </tr>
                                                                        </table>
                                                                   </td>
                                                                </tr>
