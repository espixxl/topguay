...
<tr><td>		
	<tr><td>
		<table width='100%' cellpadding='0' cellspacing='0'>	
			<tr><td class='pastillaInicio'>
					<a href='index.php'>INICIO</a>
				</td>
				<td width='8'>
					<img src='images/pastillaSeccionCierre.gif' width='8' height='32'/>
				</td>
			</tr>
			<tr>
				<td height='10'></td>
...
<tr>
<td class="opcion" id="" height="32"><a href="index.php?nid=105&idioma=es"><div>Proyecto Social</div></a></td>
</tr>
...
<tr>
   ...
   <table width="100%" cellpadding="0" cellspacing="0">
		...
		<table width='100%' cellpadding='0' cellspacing='0'>	
			<tr><td class='pastillaInicio'>
					<a href="index.php?nid=54&idioma=es">ENLACES RELACIONADOS</a>
				</td>
				<td width='8'>
					<img src='images/pastillaSeccionCierre.gif' width='8' height='32'/>
				</td>
