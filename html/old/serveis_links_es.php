<?php
	...
	while ($row = mysql_fetch_array($categories)) {
		...
		echo "<tr><td class='opcion' id='opcion".$counter."' height='32'><a id='opcion".$counter."' href='javascript:mostra(document.getElementById(\"ei".$counter."\"));'><div>".$row{'name'}."</div></a></td></tr>";
