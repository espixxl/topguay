	...
	<table width="95%" cellpadding="0" cellspacing="0">
		...
		<?php 
			...
			if (!is_null($url_video)) {
				...
				echo "<div style='padding-left:90px;padding-top:10px;'><iframe width='380' height='280' src='//www.youtube.com/embed/".$url_video."' frameborder='0' allowfullscreen></iframe></div>"; 
				echo "</td></tr>";
			}
		?>
