...
<tr><td>		
	<?php
		if ($nid>0) {
			echo "<tr><td><table width='100%' cellpadding='0' cellspacing='0'><tr><td class='pastillaInicio'><a href='index.php?idioma=es'>INICIO</a></td><td width='8'><img src='images/pastillaSeccionCierre.gif' width='8' height='32'/></td></tr><tr><td height='10'></td></tr>";
		}
	?>
	<!-- Inici modul noticies -->
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td class="pastilla">NOTICIAS</td>
...
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
<td class="opcion" id="" height="32"><a href="coneixeunos_topguay.php?idioma=es"><div>TopGuay</div></a></td>
</tr>


<tr>
<td class="opcion" id="" height="32"><a href="index.php?nid=43&idioma=es"><div>Proyecto Social</div></a></td>
</tr>

<tr>
<td class="opcion" id="" height="32"><a href="coneixeunos_contacteunos.php?idioma=es"><div>Contactar</div></a>
</td>
</tr>
</table>                                                                   
</td>
...
<div style="margin-left:auto;margin-right:auto;" width="100%">										
	<img src="images/new_logo.jpg" height="142" width="142"/>
</div>
<div class="area-contacte">
