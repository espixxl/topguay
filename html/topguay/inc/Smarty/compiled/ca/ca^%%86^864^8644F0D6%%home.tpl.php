...
<?php echo '&idioma=1\',\'src\',\'intro\',\'quality\',\'high\',\'bgcolor\',\'#ffffff\',\'allowscriptaccess\',\'sameDomain\',\'allowfullscreen\',\'false\',\'pluginspage\',\'http://www.macromedia.com/go/getflashplayer\',\'movie\',\'intro\' ); //end AC code
	}
                                              </script>
                                              <noscript>
...
<?php echo $this->_tpl_vars['seccion']; ?>
<?php echo '" src="intro.swf" quality="high" bgcolor="#ffffff" width="885" height="272" name="cabezal" align="middle" allowscriptaccess="sameDomain" allowfullscreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" FlashVars="idioma=1" />                                              
</object>
                                              </noscript>
                                            '; ?>
...
<tr>
<td class="<?php if ($this->_tpl_vars['menu'] == '3'): ?>opcionhover<?php else: ?>opcion<?php endif; ?>" id="" height="32"><a href="coneixeunos_contacteunos.php">Contacteu-nos</a>
</td>
</tr>

<!--
<tr>
<td class="<?php if ($this->_tpl_vars['menu'] == '24'): ?>opcionhover<?php else: ?>opcion<?php endif; ?>" id="" height="32"><a href="http://www.myspace.com/topguay">Blog / Notícies</a>
</td>
</tr>
-->
